...
int get_elec_data(int elec_ch)
{
	...
	char channel[2] = {0};
	//char w_buf[128] = {0};
	char w_buf[512] = "<AT_CHECK1_ELECT_[A001_001][A002_002][A003_003][B004_004][B005_005][B006_006][C007_007][C008_008][C009_009][A010_010][A011_011][A012_012][B013_013][B014_014][B015_015][C016_016]>";
	char r_buf[512] = {0};
